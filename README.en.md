...
- Content always auto-adapts to window size, even after manual resize (v26.0.0-beta)
- E-Ink/Paper style interface and reading typography (v26.0.1-beta.2)
- Content fits the window exactly; window follows late-loading images (v26.0.1-beta.3)
